...
{
	text = new wxTextCtrl(this, wxID_ANY, "This is panel 1 wee woo wee woo", wxDefaultPosition, wxSize(640, 480), wxTAB_TRAVERSAL, wxDefaultValidator, wxTextCtrlNameStr);
